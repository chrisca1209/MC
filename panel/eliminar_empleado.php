                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Eliminar Empleado</h2>
                                </div>
                            </div>
                        </div>
						<div>
							...
							<form method="POST"> 
									...
									<br><br>
									<label>Calle: </label>	<input type="text" name="calle" value="<?php echo $calle; ?>" style="width:220px" readonly="readonly" placeholder="	Nombre_Estado"/>
									<br><br>
									<label>Número: </label>	<input type="text" name="numero" value="<?php echo $numero; ?>" style="width:220px" readonly="readonly" placeholder="	Nombre_Estado"/>
									<br><br>
									<div class="overview-wrap">
		...
		if(isset($id)){
			...
			$eliminar = mysqli_query($conexion,$sql);
				if($eliminar){
					...
					window.location='ver_empleado.php';</script>";
				}else{
